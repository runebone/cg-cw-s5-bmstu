...
def process_and_plot_data(file_paths):
    ...
    for fi, file in enumerate(file_paths):
        ...
        plt.plot(grouped_data['n_objects'], grouped_data['n_triangles'], marker=markers[fi], color=colors[fi], label=f'Тест {fi+1}', linestyle=line_styles[fi])
    ...
    for fi, file in enumerate(file_paths):
        ...
        plt.plot(grouped_data['n_objects'], grouped_data['n_collisions'], marker=markers[fi], color=colors[fi], label=f'Тест {fi+1}', linestyle=line_styles[fi])
    plt.xlabel('Количество объектов')
    ...
    for fi, file in enumerate(file_paths):
        ...
        plt.plot(grouped_data['n_objects'], grouped_data['n_draw_calls'], marker=markers[fi], color=colors[fi], label=f'Тест {fi+1}', linestyle=line_styles[fi])
    plt.xlabel('Количество объектов')
    ...
    for fi, file in enumerate(file_paths):
        ...
        plt.plot(grouped_data['n_objects'], grouped_data['time_ns'], marker=markers[fi], color=colors[fi], label=f'Тест {fi+1}', linestyle=line_styles[fi])
    plt.xlabel('Количество объектов')
